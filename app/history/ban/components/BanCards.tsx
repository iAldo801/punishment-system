...
export default function BanCards() {
        ...
        const fetchUserData = async () => {
            try {
                ...
                if (userData) {
                    ...
                    const punishmentTypes = ['BAN', 'TEMPBAN'];
                    const Punishments = userData.punishments.filter((punishment: any) =>
                        punishmentTypes.includes(punishment.type)
                    );
    ...
    document.title = `${user} Ban History - Hex Bot`;
